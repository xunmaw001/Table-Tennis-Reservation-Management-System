<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="离开备注" prop="likaibeizhu">
          <el-input v-model="ruleForm.likaibeizhu" 
              placeholder="离开备注" clearable  :readonly="ro.likaibeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="离开备注" prop="likaibeizhu">
              <el-input v-model="ruleForm.likaibeizhu" 
                placeholder="离开备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shoujihaoma = true;
          ...
          if(o=='likaibeizhu'){
            this.ruleForm.likaibeizhu = obj[o];
	    this.ro.likaibeizhu = true;
            continue;
          }
          if(o=='likaishijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `likaishenqing/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.likaishenqingCrossAddOrUpdateFlag = false;
						 this.parent.search();
