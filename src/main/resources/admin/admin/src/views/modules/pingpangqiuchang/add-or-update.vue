    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="配套设施" prop="peitaosheshi">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.peitaosheshi" label="配套设施" prop="peitaosheshi">
                    <span>{{ruleForm.peitaosheshi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `pingpangqiuchang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.pingpangqiuchangCrossAddOrUpdateFlag = false;
						 this.parent.search();
